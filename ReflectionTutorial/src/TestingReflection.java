...
public class TestingReflection {
	...
	public static void main(String[] args) {
		...
		try {
			...
			constructor2 = reflectClass.getConstructor(int.class, String.class).newInstance(312, "Random String");

			int val = ((UFOEnemyShip) constructor2).myNymber;
			System.out.println(val);

			// int val2 = ((UFOEnemyShip)((Object)constructor)).myNymber;
		...
		try {
			...
			System.out.println("EnemyShip Private idCode: " + valueOfName);
